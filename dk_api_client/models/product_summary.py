...
class ProductSummary(object):
    ...
    def __init__(self, product_url=None, description=None, manufacturer=None, manufacturer_product_number=None, unit_price=None, quantity_available=None, _configuration=None):  # noqa: E501
