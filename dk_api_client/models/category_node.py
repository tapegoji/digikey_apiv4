...
class CategoryNode(object):
    ...
    def __init__(self, category_id=None, parent_id=None, name=None, product_count=None, new_product_count=None, image_url=None, seo_description=None, child_categories=None, _configuration=None):  # noqa: E501
