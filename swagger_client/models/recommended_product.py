...
class RecommendedProduct(object):
    ...
    def __init__(self, digi_key_product_number=None, manufacturer_product_number=None, manufacturer_name=None, primary_photo=None, product_description=None, quantity_available=None, unit_price=None, product_url=None, _configuration=None):  # noqa: E501
