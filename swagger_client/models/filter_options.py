...
class FilterOptions(object):
    ...
    """
    swagger_types = {
        'manufacturers': 'list[BaseFilterV3]',
        'packaging': 'list[BaseFilterV3]',
        'status': 'list[BaseFilterV3]',
        'series': 'list[BaseFilterV3]',
    ...
    def __init__(self, manufacturers=None, packaging=None, status=None, series=None, parametric_filters=None, top_categories=None, market_place_filters=None, _configuration=None):  # noqa: E501
