...
class Classifications(object):
    ...
    def __init__(self, reach_status=None, rohs_status=None, moisture_sensitivity_level=None, export_control_class_number=None, htsus_code=None, _configuration=None):  # noqa: E501
